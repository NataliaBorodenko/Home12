import org.example.ListFilms;
import org.example.ListFilmsManager;
...
public class ListFilmsManagerTest {
    ...
    ListFilms film2 = new ListFilms(2, "Вперед", "мультфильм", "с 12 марта");
    ListFilms film3 = new ListFilms(3, "Отель Белград", "комедия", "с 5 марта");
    ListFilms film4 = new ListFilms(4, "Джентельмены", "боевик", "с 13 фувраля");
